...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="statics/logo.jpeg">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/logo.jpeg">
    ...
    <title>About us - Sparks Foundation Bank</title>
...
<body style="background-color:#212529">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Komal Dhok</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> J.J.Magdum College of Engineering,Jaysingpur</b></p>
    </center>
