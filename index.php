...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/PngItem_5146697.jpeg">
    <link rel="icon" type="image/jpeg" sizes="32x32" href="statics/logo.jpeg">
    <link rel="icon" type="image/jpeg" sizes="16x16" href="statics/logo.jpeg">
    ...
    <title>Welcome to Sparks Foundation Bank</title>
...
<div id="lock"><img src="statics/—Pngtree—creative abstract wave design_5759740.jpg" alt="" style="width:100%; margin-top:10%;"><br>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logo.jpeg" alt=""
    ...
    <div class="container-large"
        style="color:cyan; height:500px; width: 100%; padding:3% 2% 2% 2%; background-color:#212529;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:65%; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Sparks Foundation<br>
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:8% 0% 0% 2%; text-align:center;">
                &nbsp;<img src="statics/finance.jpeg" class="zoomin" alt="" style="width:5px;">
            </div>
        </div>
    </div>
