...
<head>
    ...
    <title>Contact us - Sparks Foundation Bank</title>
</head>
...
echo "<tbody>";
        ...
        if(!(empty($row['sender']) && empty($row['receiver']) && empty($row['amount'])))
            ...
            <tr>
              ...
              <td>'.$row['receiver'].'</td>
              <td>'.$row['amount'].'</td>
              <td>'; ?> <?php if($row['status'] == "Failed"){echo '<b><p style="color:red;">Succeed</p></b>';}else{echo '<b><p style="color:green;">Succeed</p></b>';} ?>
              <?php echo '</td>
              </tr>';}
    }
